...
import { jharkhakndImages } from '../data/images.ts';
...
const RouterHomePage = () => {
  ...
  const heroSlides = [
    {
      image: jharkhakndImages.hero.netarhat,
      ...
      gradient: 'from-jungle-green-600/70 to-black/50'
    },
    {
      image: jharkhakndImages.hero.hundru,
      ...
      gradient: 'from-terracotta-600/70 to-black/50'
    },
    {
      image: jharkhakndImages.hero.deoghar,
      ...
      gradient: 'from-warm-yellow-600/70 to-black/50'
    },
    {
      image: jharkhakndImages.hero.betla,
      title: 'Wildlife & Adventure Trails',
      subtitle: 'Encounter exotic wildlife and embark on thrilling adventures',
      location: 'Betla National Park',
      gradient: 'from-green-700/70 to-black/50'
    }
  ];
  ...
  const exploreCategories = [
    {
      ...
      image: jharkhakndImages.categories.eco,
    ...
    },
    {
      ...
      image: jharkhakndImages.categories.culture,
    ...
    },
    {
      ...
      image: jharkhakndImages.categories.pilgrimage,
    ...
    },
    {
      ...
      image: jharkhakndImages.categories.adventure,
  ...
  const suggestedTrips = [
    {
      ...
      image: jharkhakndImages.trips.eco,
      price: '₹8,500',
      rating: 4.8,
    ...
    },
    {
      ...
      image: jharkhakndImages.trips.culture,
      price: '₹12,000',
      rating: 4.9,
    ...
    },
    {
      ...
      image: jharkhakndImages.trips.spiritual,
      price: '₹15,500',
      rating: 4.7,
    ...
    },
    {
      ...
      image: jharkhakndImages.trips.wildlife,
      price: '₹10,500',
      rating: 4.8,
    ...
    },
    {
      ...
      image: jharkhakndImages.trips.heritage,
      price: '₹18,000',
      rating: 4.6,
  ...
  const seasonalFestivals = [
    {
      ...
      image: jharkhakndImages.festivals.sarhul,
    ...
    },
    {
      ...
      month: 'September',
      location: 'Hazaribagh',
      image: jharkhakndImages.festivals.karma,
    ...
    },
    {
      ...
      image: jharkhakndImages.festivals.tusu,
    ...
    },
    {
      ...
      image: jharkhakndImages.festivals.janiShikar,
  ...
  const featuredHomestays = [
    {
      ...
      rating: 4.8,
      price: '₹3,200',
      image: jharkhakndImages.homestays.ecoValley,
    ...
    },
    {
      ...
      rating: 4.9,
      price: '₹2,800',
      image: jharkhakndImages.homestays.tribalHeritage,
    ...
    },
    {
      ...
      rating: 4.7,
      price: '₹4,500',
      image: jharkhakndImages.homestays.forestLodge,
